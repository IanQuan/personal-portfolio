...
const projects = [
...

  {
    ...
    problem: "What is the problem A11YLabs Simulation UI solving? A11YLabs Simulation UI addresses the challenge of understanding and implementing the complex and legally intricate Web Content Accessibility Guidelines (WCAG) by providing a platform where software developers and accessibility testers can simulate and customize WCAG violations. This tool simplifies the process of testing and adjusting web content for accessibility, making it easier to identify potential barriers and ensure compliance. It offers a hands-on experience that helps users comprehend the practical impact of accessibility issues, thereby facilitating more effective implementation of accessibility standards. \n\n Differences between A11YLabs Simulation UI and existing applications? Unlike many existing tools that focus mainly on detecting accessibility issues, A11YLabs Simulation UI emphasizes simulating WCAG violations to allow users to experience accessibility barriers firsthand. This approach fosters a deeper understanding of the impact on users with disabilities. Additionally, A11YLabs Simulation UI integrates a Virtual Assistant powered by an OpenAI language model, enhancing the efficiency of the application and reducing the workload of support teams. This AI-driven assistance for information retrieval and issue resolution stands out from other tools, which often lack such advanced features and focus solely on compliance without enabling customization or simulation. \n\nWho are the target users? The target users of A11YLabs Simulation UI include accessibility testers, software developers, and project stakeholders. Accessibility testers use the tool to ensure software compliance with accessibility standards and to communicate the importance of accessible design within teams. Software developers employ the platform to integrate accessibility considerations early in the development process and gain firsthand experience of accessibility barriers. Project stakeholders, such as project managers or team leads, use the tool to ensure that accessibility is a priority throughout the development lifecycle and to verify that company expectations regarding accessibility are being met.",
    detail_title: 'Main Features',
    other_link: '',
    features: [
      {
